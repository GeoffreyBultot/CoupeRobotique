...
markerLength = 10#0.25 # Here, our measurement unit is centimetre.
...
# Capture frame-by-frame
	...
	x1 = (res[2][0][0][0][0], res[2][0][0][0][1])
	x2 = (res[2][0][0][1][0], res[2][0][0][1][1])
	x3 = (res[2][0][0][2][0], res[2][0][0][2][1])
	x4 = (res[2][0][0][3][0], res[2][0][0][3][1])
